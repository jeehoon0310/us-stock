...
const NAV = [
  ...
  // 관리자 전용 (하단 배치)
  { href: "/performance", icon: "trending_up",     labelKey: "nav.performance",  adminOnly: true  },
...
const MOBILE_NAV = [
  ...
  { href: "/performance", icon: "trending_up",  labelKey: "nav.mobile.performance", adminOnly: true },
